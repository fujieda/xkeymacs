...
です。いくつかのバグも直してあります。32bit版のWindowsでも動きます。
...
XKeymacs version 3.47から改変されていない部分の著作権は、
大石(oishi@cam.hi-ho.ne.jp)さんにあります。改変した部分の著作権は
藤枝和宏(fujieda@users.sourceforge.jp)にあります。
